...
const defaultProducts = [
  { id: "cement-50kg", name: "Portland Cement 50kg", category: "Cement", price: 890, stock: 420, sold: 0, revenue: 0, unit: "bag", image: "https://images.unsplash.com/photo-1581094288338-2314dddb7ece?auto=format&fit=crop&w=800&q=80", description: "General purpose cement for slabs, columns, plaster, and masonry.", tag: "In stock" },
  { id: "rebar-12mm", name: "TMT Steel Rebar 12mm", category: "Steel", price: 760, stock: 260, sold: 0, revenue: 0, unit: "length", image: "https://images.unsplash.com/photo-1518709268805-4e9042af2176?auto=format&fit=crop&w=800&q=80", description: "High-strength reinforcement steel for foundations and structural work.", tag: "Bulk deal" },
  { id: "blocks-6-inch", name: "Concrete Blocks 6 inch", category: "Masonry", price: 95, stock: 3800, sold: 0, revenue: 0, unit: "block", image: "https://images.unsplash.com/photo-1590644365607-1c5a6f219439?auto=format&fit=crop&w=800&q=80", description: "Machine-made blocks for walling, boundary works, and partitions.", tag: "Fast moving" },
  { id: "river-sand", name: "Washed River Sand", category: "Aggregates", price: 6200, stock: 36, sold: 0, revenue: 0, unit: "ton", image: "https://images.unsplash.com/photo-1531834685032-c34bf0d84c77?auto=format&fit=crop&w=800&q=80", description: "Clean washed sand for mortar, plastering, and concrete mixes.", tag: "Site delivery" },
];
...
function ensureProducts() {
  const existing = readStore("ophraProducts", null);
  if (existing?.length) return existing;
  writeStore("ophraProducts", defaultProducts);
...
productForm.addEventListener("submit", (event) => {
  ...
  const product = {
    ...
    sold: 0,
    revenue: 0,
    image: document.querySelector("#productImage").value.trim() || "https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=800&q=80",
